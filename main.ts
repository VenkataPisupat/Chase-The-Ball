...
mySprite2 = sprites.create(img`
    ...
    . . f 1 1 1 b b b f b b b b f . . 
    . f f f f f f b b f f f f f f f . 
    . f b b b b f f f f f b b b b f . 
    f b b b b f f f f b b f b b b c f 
    f b b b f f b b f b b b f b c c f 
    f b b f b b b b f f b b b f f c f 
    f f f f f b b b b f b b b c c f c 
    f b f b f f b b b f f b c c c c f 
    f f f b b f b b b b f b c c c c f 
    f f b b b f f b b c f c c c c c f 
    . f b b b c f c c c f c c c c f . 
    . f b b c c f c c c c f c c c f . 
    . . f c c c f c c c c f c c f . . 
    . . . f f c f f c c c f f f . . . 
    . . . . . f f f f f f f . . . . . 
